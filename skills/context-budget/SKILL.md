---
name: context-budget
description: "审计 Claude Code 上下文窗口在 agents、skills、MCP servers 与 rules 上的消耗。识别膨胀与冗余组件，产出按优先级排序的 token 节省建议。当上下文窗口消耗过快、需要定位是哪些 agents、skills、MCP servers 或 rules 在占用时使用。"
metadata:
  origin: ECC
---
