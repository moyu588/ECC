...
description: "数据库迁移最佳实践：schema 变更、数据迁移、回滚与零停机部署，覆盖 PostgreSQL、MySQL 与常见 ORM（Prisma、Drizzle、Kysely、Django、TypeORM、golang-migrate）。在编写 schema/数据迁移、规划回滚或追求零停机部署时使用。"
metadata:
  origin: ECC
---
