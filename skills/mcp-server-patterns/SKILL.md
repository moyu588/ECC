...
description: "用 Node/TypeScript SDK 构建 MCP server：tools、resources、prompts、Zod 校验、stdio vs Streamable HTTP。最新 API 请查 Context7 或 MCP 官方文档。在构建或调试 MCP server（tools、resources、prompts、校验或传输选型）时使用。"
metadata:
  origin: ECC
---
